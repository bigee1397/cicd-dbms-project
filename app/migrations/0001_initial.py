    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(max_length=2, verbose_name=(('A', 'Airpods'), ('PC', 'Phone Cases'), ('DB', 'Designer Bottles'), ('M', 'Men'), ('W', 'Women'), ('M', 'Masks')))),
            ],
        ),
        migrations.CreateModel(
            name='OrderPlaced',
