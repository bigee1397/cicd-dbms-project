...
from GBM.settings import MEDIA_URL,MEDIA_ROOT
...
path('removecart/', views.remove_cart),
    ...
    path('masks/<slug:data>', views.masks, name='masksdata'),
    path('airpod/', views.airpod, name='airpod'),
    path('airpod/<slug:data>', views.airpod, name='airpoddata'),
    path('womens/', views.womens, name='womens'),
    path('womens/<slug:data>', views.womens, name='womensdata'),
    path('phonecase/', views.phonecase, name='phonecase'),
    path('phonecase/<slug:data>', views.masks, name='phonecasedata'),
